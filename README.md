...
10uF,"Bulk decoupling (0805, X5R, 16V)",4,$0.10,$0.40,Link,Digikey,
10uF,"Bulk decoupling (0805, X5R, 16V)",3,$0.10,$0.30,Link,Digikey,"Same as above, separate line per CSV"
47nF,"Filter cap, possibly BQ25883 ILIM or feedback (0603)",1,$0.02,$0.02,Link,Digikey,
44uF,Unusual value — check schematic,1,$0.50,$0.50,Link,Digikey,"44µF is non-standard. Did you mean 4.7µF, 47µF, or this for a specific regulator output?"
...
.383k Ohm,Precision resistor — likely BQ25883 ISET or regulator FB,1,$0.10,$0.10,Link,Digikey,"383Ω, 1% — verify exact value from schematic"
