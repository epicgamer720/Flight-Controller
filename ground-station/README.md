...
as **one argument with the inner double quotes intact**, because arduino-cli splits
...
> native-argument rules; **not yet verified by an actual compile**, since arduino-cli
